  ...
  const planConfigs = [
    {
      ...
      price: '$100',
      period: '/month',
      desc: 'Great for growing schools getting started with essential academic and attendance tools.',
      accent: '#3B82F6',
      ...
      features: [
        ...
        'Teacher Lesson Planning & Grading',
        'Daily Attendance & Roll-Call',
        'Report Cards & Term Transcripts',
    ...
    },
    {
      ...
      price: '$300',
      period: '/month',
      desc: 'Ideal for established schools needing conflict-free timetabling, digital vault, and parent messaging.',
      accent: '#FF6B00',
      ...
      features: [
        ...
        'Physical Library & Digital Vault',
        'Two-Way Messaging & School Calendar',
    ...
    },
    {
      ...
      price: '$500',
      period: '/month',
      desc: 'Built for comprehensive institutions needing custom roles, multi-tier fees, clearance, and priority support.',
      accent: '#8B5CF6',
      ...
      features: [
        ...
        'Multi-Tier Fees & Invoicing',
        'Student Leaving Clearance & Conduct',
  ...
  const addOns = [
    {
      ...
      price: '$30/mo',
      accent: '#8B5CF6',
      desc: 'Curated online repository for study notes, revision guides, and past exam papers.',
    ...
    },
    {
      ...
      price: '$30/mo',
      accent: '#10B981',
      desc: 'Set class and student fee structures, track payments, and generate PDF receipts.',
    ...
    },
    {
      ...
      price: '$5/mo',
      accent: '#FF6B00',
      desc: 'Two-way instant messaging, urgent school notices, and shared calendar events.',
      included: 'Included in Pro & Premium',
    ...
    },
    {
      ...
      price: '$15/mo',
      accent: '#3B82F6',
      desc: 'Librarian-mediated book checkouts, barcode lookup, and inventory tracking.',
      included: 'Included in Pro & Premium',
