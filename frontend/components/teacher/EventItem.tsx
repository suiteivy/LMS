...
const EventItem: React.FC<EventItemProps> = ({ event }) => {
 ...
 return (
 <View className="flex-row items-center py-3 border-b border-[#D0D7DE] dark:border-[#21262D] last:border-b-0">
 <View
 ...
 <Text className="text-gray-500 dark:text-gray-400 text-xs mt-1">{event.date}</Text>
 </View>
 </View>
 );
};
