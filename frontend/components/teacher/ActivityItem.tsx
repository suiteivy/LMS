...
const ActivityItem: React.FC<ActivityItemProps> = ({ activity }) => {
 ...
 return (
 <View className="flex-row items-center p-4 border-b border-[#D0D7DE] dark:border-[#21262D]">
 <View
 ...
 <Text className="text-gray-500 dark:text-gray-400 text-xs mt-1">{activity.time}</Text>
 </View>
 </View>
 );
};
