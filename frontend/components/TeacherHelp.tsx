...
export default function TeacherHelp() {
 ...
 {/* Search Bar */}
 <View className="flex-row items-center bg-white border border-gray-200 rounded-lg px-4 py-3 mb-8">
 ...
 className="w-[48%] bg-white p-5 rounded-lg border border-gray-100 items-center"
 >
 ...
 disabled={submitting}
 className="bg-teal-600 py-4 rounded-lg items-center w-full flex-row justify-center"
 >
