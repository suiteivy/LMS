import { BookOpen, Edit3, GraduationCap, Mail, Save, X, Briefcase } from "lucide-react-native";
            ...
            <View className="p-4 md:p-8 max-w-3xl mx-auto w-full">
                ...
                <View className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <View className="mt-6 flex-row flex-wrap justify-between">
                        ...
                        <View className="mt-2 bg-white p-5 rounded-2xl border border-gray-100 shadow-sm w-full">
                            <View className="flex-row items-center justify-between mb-4">
                                <View className="flex-row items-center">
                                    <BookOpen size={20} color="#0d9488" />
                                    <Text className="ml-3 font-semibold text-gray-800">Assigned Courses</Text>
                                </View>
                            </View>

                            <View className="border-t border-gray-50 pt-2">
                                {['Advanced Mathematics', 'Computer Science 101', 'Creative Writing'].map((course, index) =>
