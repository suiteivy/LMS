...
export const DebugOverlay: React.FC = () => {
 ...
 <Text className="text-[10px] text-gray-500 dark:text-gray-400"> {new Date(log.timestamp).toLocaleTimeString()}
 </Text>
 </View>
 ...
 <TouchableOpacity
 className="bg-[#FF6900] p-4 items-center m-4 rounded-lg"
