...
export const GradeDetailModal = ({ visible, onClose, subjectName, lecturerName, examMark, testScores }: GradeDetailModalProps) => {
 ...
 {/* Summary Card */}
 <View className="bg-gray-900 dark:bg-[#1a1a1a] p-6 rounded-xl mb-8 shadow-xl border border-transparent dark:border-gray-800">
 <View className="mb-4">
 ...
 <View className="bg-orange-50 dark:bg-orange-950/20 p-5 rounded-xl border border-orange-100 dark:border-orange-900/30">
