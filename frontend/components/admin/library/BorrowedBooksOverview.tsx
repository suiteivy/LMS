...
const BorrowedBooksOverview: React.FC<BorrowedBooksOverviewProps> = ({
            ...
            >
                <View className="flex-row justify-between items-start mb-3">
                    <View className="flex-1">
                        ...
                        <Text className="text-md text-[#FD6900] dark:text-[#FD6900] mb-1">
                            by {borrowedBook.author}
                        </Text>
                        <Text className="text-xs mb-2" style={{ color: textMuted }}>
                        ...
                        <View className="flex-1">
                            ...
                            <View className="flex-row flex-wrap gap-2 mb-1">
                                {borrowedBook.borrowerDisplayId && (
                                    <Text className="text-[10px] bg-[#FD6900] dark:bg-[#FD6900]/30 text-[#FD6900] dark:text-[#FD6900] font-bold px-2 py-0.5 rounded-md uppercase tracking-wider">
                ...
                {borrowedBook.status !== "returned" && (
                    <View className="flex-row justify-between">
                        <>
                            <TouchableOpacity
                                className="bg-[#FF6900] flex-1 py-2 px-3 rounded-lg mr-2 active:bg-orange-600"
    ...
    if (loading && borrowedBooks.length === 0) {
        return (
            <View className="flex-1 justify-center items-center" style={{ backgroundColor: pageBg }}>
                <ActivityIndicator size="large" color="#fd6900" />
                <Text className="mt-2" style={{ color: textMuted }}>Loading borrowed books...</Text>
            </View>
        );
    }
    ...
    return (
        <View className="flex-1" style={{ backgroundColor: pageBg }}>
            ...
            >
                <View
                    className="flex-row items-center rounded-xl px-4 py-2 mt-2 mb-4"
                    style={{ backgroundColor: surfaceBg, borderWidth: 1, borderColor }}
                >
                    ...
                    {selectedBook && (
                        <ScrollView className="flex-1 p-4">
                            <View
                                ...
                                style={{ backgroundColor: cardBg, borderWidth: 1, borderColor }}
                            >
                                <Text className="font-semibold mb-1" style={{ color: textPrimary }}>
                            ...
                            <View className="mb-6">
                                ...
                                <TextInput
                                    className="bg-gray-50 dark:bg-gray-800 border border-[#D0D7DE] dark:border-[#21262D] rounded-lg p-3 h-20 text-slate-800 dark:text-white"
                                    value={notes}
                            ...
                            {showReturnConfirm && selectedBook && (
                                <View style={{
                                    ...
                                    {notes
                                        ? <Text style={{ fontSize: 12, color: isDark ? '#9ca3af' : '#6b7280', marginBottom: 12 }}>Notes: {notes}</Text>
                                    ...
                                    <View style={{ flexDirection: 'row', gap: 12 }}>
                                        <TouchableOpacity
                                            ...
                                            style={{ flex: 1, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: isDark ? '#21262D' : '#D0D7DE', alignItems: 'center' }}
                                        >
                                            <Text style={{ fontSize: 12, fontWeight: '700', color: isDark ? '#9ca3af' : '#6b7280' }}>Cancel</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity
                                            activeOpacity={0.7}
                                            onPress={processReturn}
                                            style={{ flex: 1, paddingVertical: 10, borderRadius: 10, backgroundColor: '#FF6900', alignItems: 'center' }}
                                        >
                                            <Text style={{ fontSize: 12, fontWeight: '800', color: '#ffffff' }}>Confirm Return</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            )}
