...
"Failed to process fine. Please try again.",
 ...
 <View
 key={borrowedBook.id}
 className="bg-white dark:bg-gray-900 rounded-xl p-4 mb-3 border border-slate-200 dark:border-gray-700"
 >
 ...
 <View className="flex-row items-center bg-[#FFFFFF] dark:bg-[#0D1117]-surface border border-teal-100 dark:border-gray-800 rounded-xl px-4 py-2 mt-2 mb-4">
 ...
 <View className="bg-[#FFFFFF] dark:bg-[#0D1117]-surface p-4 rounded-lg mb-4">
