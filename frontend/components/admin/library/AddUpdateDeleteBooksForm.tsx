...
const AddUpdateDeleteBooksForm: React.FC<AddUpdateDeleteBooksFormProps> = ({
 ...
 <View
 key={book.id}
 className="bg-[#FFFFFF] dark:bg-[#0D1117]-surface rounded-xl p-4 mb-3 border border-teal-100 dark:border-teal-900"
 >
 ...
 <View className="flex-row items-center bg-[#FFFFFF] dark:bg-[#0D1117]-surface border border-teal-100 dark:border-gray-800 rounded-xl px-4 py-2">
 ...
 <TextInput
 className="bg-[#FFFFFF] dark:bg-[#0D1117]-surface border border-[#D0D7DE] dark:border-[#21262D] rounded-lg p-3 text-gray-900 dark:text-white"
