          ...
          {terms.map((term) => (
            ...
            >
              <Calendar
                size={12}
                color={
                  selectedTerm === term.id ? '#fff' : isDark ? '#9CA3AF' : '#6B7280'
                }
              />
              <Text
                style={[
      ...
      {selectedTermObj?.locked_at ? (
        <View style={{
          ...
          <Text style={{ color: isDark ? '#FCA5A5' : '#991B1B', fontSize: 13, flex: 1 }}>
            Selected term is locked. This report remains read-only.
          </Text>
        </View>
      ) : null}
              ...
              <View key={card.id} style={styles.card}>
                ...
                <View style={styles.statsRow}>
                  ...
                  <View style={styles.statBlock}>
                    ...
                    <Text style={styles.statValue}>
                      {card.overall_average != null ? card.overall_average.toFixed(1) : '—'}
                ...
                {isExpanded && (
                  <View style={styles.expandedSection}>
                    ...
                    {/* Teacher Remarks */}
                    {card.teacher_remarks && card.teacher_remarks.length > 0 && (
                      <>
                        ...
                        {card.teacher_remarks.map((remark, rIdx) => (
                          <View key={rIdx} style={styles.remarkCard}>
                            ...
                            <Text style={styles.remarkText}>{remark.remarks}</Text>
