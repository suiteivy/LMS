...
const PaymentRow = ({ payment }: { payment: Payment }) => {
 ...
 <View className="w-12 h-12 rounded-lg bg-orange-100 dark:bg-orange-950/20 items-center justify-center mr-4">
 ...
 <Text className="text-gray-900 dark:text-white font-bold text-lg">{formatKES(convertUSDToKES(payment.amount))}</Text>
...
export default function EarningsPage() {
 ...
 <TouchableOpacity className="w-10 h-10 bg-[#F6F8FA] dark:bg-[#161B22] rounded-lg items-center justify-center border border-[#D0D7DE] dark:border-[#21262D] active:bg-gray-50 dark:active:bg-gray-900">
 ...
 {/* Status Card */}
 <TouchableOpacity className="bg-orange-50 dark:bg-orange-950/20 p-6 rounded-[40px] mt-8 flex-row items-center border border-orange-100 dark:border-orange-900 active:bg-orange-100 dark:active:bg-orange-900">
 <View className="flex-1">
