                ...
                <View className="flex-1 bg-black/50 justify-center p-6">
                    <View className="bg-[#FFFFFF] dark:bg-[#161B22] rounded-[40px] p-8">
                            ...
                            <ScrollView style={{ maxHeight: 200 }} className="bg-[#FFFFFF] dark:bg-[#161B22] rounded-lg overflow-hidden">
                                {students.map((s) => (
                                    <TouchableOpacity
                                        ...
                                        className={`p-4 border-b border-[#D0D7DE] dark:border-[#21262D] ${selectedStudentId === s.id ? 'bg-orange-50 dark:bg-orange-950/20' : ''}`}
                                    >
                                        <Text className={`font-medium ${selectedStudentId === s.id ? 'text-[#FF6900]' : 'dark:text-white'}`}>{s.name}</Text>
                                    </TouchableOpacity>
                                ))}
                            </ScrollView>
                        </View>
                        ...
                        <TouchableOpacity
                            ...
                            className={`h-16 rounded-xl items-center justify-center ${!selectedStudentId ? 'bg-gray-200' : 'bg-[#FF6900] shadow-lg shadow-orange-500/30'}`}
                        >
                            {isIssuing ? (
