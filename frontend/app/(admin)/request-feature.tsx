        ...
        <View className="flex-1 bg-white dark:bg-navy">
            ...
            >
                    ...
                    {ADDON_OPTIONS.map((item) => {
                        ...
                        return (
                            <TouchableOpacity
                                ...
                                disabled={isOwned}
                                className={`flex-row items-center p-5 rounded-[32px] border-2 ${
                                    isSelected 
                                    ? 'border-orange-500 bg-orange-50/50 dark:bg-orange-900/10' 
                                    : 'border-gray-100 dark:border-gray-800 bg-white dark:bg-navy-surface'
                                } ${isOwned ? 'opacity-50' : ''}`}
                                style={{
                ...
                <View className="mt-10">
                    ...
                    <TextInput
                        className="bg-gray-50 dark:bg-navy-surface border border-gray-100 dark:border-gray-800 rounded-3xl p-5 text-gray-900 dark:text-white text-base min-h-[120]"
            ...
            <Modal visible={success} transparent animationType="fade">
                <View className="flex-1 bg-black/60 items-center justify-center p-6">
                    <View className="bg-white dark:bg-navy-surface w-full max-w-sm rounded-[40px] p-10 items-center border border-gray-100 dark:border-gray-800">
                        ...
                        <TouchableOpacity
                            ...
                            className="bg-gray-900 dark:bg-white w-full py-4 rounded-2xl items-center"
                        >
