...
export const TeacherPayoutSection: React.FC<TeacherPayoutSectionProps> = ({
  ...
  return (
    <View className="flex-1">
      <View className="mb-4">
        <Text className="text-2xl font-bold text-gray-900 mb-4">Teacher Payouts</Text>
        
        {/* Summary Cards */}
        <View className="flex-row space-x-3 mb-4">
          <View className="flex-1 bg-blue-50 rounded-lg p-4">
            <Text className="text-sm text-blue-600 font-medium">Total Pending</Text>
          ...
          <View className="flex-1 bg-green-50 rounded-lg p-4">
            <Text className="text-sm text-green-600 font-medium">This Month</Text>
            <Text className="text-2xl font-bold text-green-700">
              {payouts.filter(p => p.status === 'paid').length}
            </Text>
            <Text className="text-sm text-green-600">Payouts processed</Text>
          </View>
        </View>
