...
type LibrarySection = "overview" | "books" | "borrowed" | "config" | "returned";
...
const LibraryAction = () => {
  ...
  const [borrowedBooks, setBorrowedBooks] = useState<BorrowedBook[]>([
    ...
    },
    {
      ...
      isbn: "978-1234567891",
      borrowerId: "u002",
      borrowerName: "Lucky Katana",
      borrowerEmail: "lucky@example.com",
      borrowDate: new Date("2025-08-01"),
    ...
    },
    {
      ...
      borrowerId: "u005",
      borrowerName: "Leon Gabriel",
      borrowerEmail: "lyongabriel746@gmal.com",
      borrowDate: new Date("2025-07-24"),
      dueDate: new Date("2025-08-10"),
    ...
    },
    {
      ...
      isbn: "978-0977654391",
      borrowerId: "u006",
      borrowerName: "Maxwel Lantin",
      borrowerEmail: "lanting@example.com",
      borrowDate: new Date("2025-07-24"),
      dueDate: new Date("2025-08-10"),
      returnDate: new Date("2025-08-16"),
      status: "returned",
  ...
  const handleSendReminder = (borrowId: string) => {
    // email reminder logic to be implemented
          ...
          <View className="bg-white rounded-xl p-4 shadow-sm border border-slate-200">
            ...
            <View className="space-y-3">
              <View className="flex-row items-center">
                ...
                <View className="flex-1">
                  <Text className="text-sm text-slate-800">
                    New book added: "React Native Guide"
                  </Text>
              ...
              <View className="flex-row items-center">
                ...
                <View className="flex-1">
                  <Text className="text-sm text-slate-800">
                    Book overdue: "JavaScript Essentials"
                  </Text>
              ...
              <View className="flex-row items-center">
                ...
                <View className="flex-1">
                  <Text className="text-sm text-slate-800">
                    Book returned: "TypeScript Handbook"
                  </Text>
