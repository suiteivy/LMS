...
export default function Index() {
  ...
  if (loading) {
    return (
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "#0F0B2E" }}>
      ...
      >
        <View style={{
          ...
          {[
            ...
            { label: "Sign In", onPress: () => router.push("/(auth)/signIn"), accent: true },
          ].map((item) => (
            <TouchableOpacity
              key={item.label}
        ...
        >
          ...
          <View style={{
            ...
            <Animated.View style={{
              ...
              <View style={{
                ...
                <Text style={{
                  color: "#FF8C40", fontSize: 12, fontWeight: "700",
              ...
              <View style={{ height: 70, width: 40, alignItems: "center" }}>
                {[0, 1, 2].map((index) => {
                  ...
                  const translateY = scrollAnimation.interpolate({
                    inputRange: [Math.max(0, offset), Math.min(0.4 + offset, 1), 1],
                    outputRange: [0, 10, 10],
                    extrapolate: "clamp",
                  });
                  const opacity = scrollAnimation.interpolate({
                    inputRange: [
                      Math.max(0, offset), Math.min(0.15 + offset, 1),
                      Math.min(0.35 + offset, 1), Math.min(0.55 + offset, 1), 1,
                    ],
                  ...
                  return (
                    <Animated.View
                      key={index}
                      style={{
                        position: "absolute", top: index * 18,
          ...
          <View
            ...
            <View style={{
              ...
              {[
                { icon: <BookOpen size={22} color="#FF8C40" />, title: "Courses", desc: "Browse, enroll, and manage courses with ease.", gradient: ["#FF6B00", "#FF8C40"] },
                { icon: <Library size={22} color="#A78BFA" />, title: "Library", desc: "Access digital books and resources anytime.", gradient: ["#7C3AED", "#A78BFA"] },
                { icon: <CreditCard size={22} color="#60A5FA" />, title: "Payments", desc: "Track fees and manage payments simply.", gradient: ["#2563EB", "#60A5FA"] },
                { icon: <BarChart2 size={22} color="#34D399" />, title: "Analytics", desc: "Get actionable insights and reports.", gradient: ["#059669", "#34D399"] },
                { icon: <Users size={22} color="#F472B6" />, title: "Users", desc: "Manage students, teachers, and admins.", gradient: ["#DB2777", "#F472B6"] },
                { icon: <Settings size={22} color="#FBBF24" />, title: "Settings", desc: "Customize your experience to your needs.", gradient: ["#D97706", "#FBBF24"] },
              ].map(({ icon, title, desc, gradient }) => (
                <Pressable
                  key={title}
                  style={({ pressed }) => ({
                    maxWidth: 340, minWidth: "46%", flexBasis: "46%", flexGrow: 1,
                ...
                >
                  ...
                  <Text style={{ color: "white", fontWeight: "800", fontSize: 17, marginBottom: 6 }}>
                    {title}
                  </Text>
          ...
          <View
            ...
            <Text style={{
              ...
              textAlign: "center", maxWidth: 320, marginBottom: 20,
            }}>
              Explore the platform instantly — no signup required. Try every role and feature live.
            </Text>
            <TouchableOpacity
              style={{
                backgroundColor: "#FF6B00",
          ...
          {/* ═══════════════════════ FOOTER ═══════════════════════ */}
          <View style={{ alignItems: "center", paddingHorizontal: 32, paddingBottom: 24, paddingTop: 32 }}>
            ...
            >
              <Text style={{ color: "#FF8C40", fontWeight: "700", fontSize: 15 }}>
                Sign In
              </Text>
            </TouchableOpacity>
          </View>
    ...
    <View style={{
      ...
      {isPremium && (
        <View style={{
          ...
          <Text style={{
            ...
            fontSize: 11, letterSpacing: 2, textTransform: "uppercase", marginLeft: 6,
          }}>
            Enterprise
          </Text>
      ...
      {tier === "trial" && s.badgeLabel && (
        <View style={{
          ...
          borderBottomWidth: 1, borderBottomColor: "rgba(100,116,139,0.15)",
        }}>
          <Text style={{
            color: s.badgeText, fontWeight: "800",
      ...
      <View style={{ padding: 24, alignItems: "center", flex: 1 }}>
        {/* Title */}
        <Text style={{
          color: s.titleColor, fontWeight: "800",
          fontSize: 15, letterSpacing: 2, marginBottom: 12,
        }}>
          {title}
        </Text>
        ...
        <View style={{ flexDirection: "row", alignItems: "baseline", marginBottom: 24 }}>
          <Text style={{ fontSize: 22, fontWeight: "800", color: "rgba(255,255,255,0.7)" }}>$</Text>
          <Text style={{
            fontSize: isPro ? 52 : 44, fontWeight: "900",
            color: isPro ? "#22C55E" : isPremium ? "#F59E0B" : "white",
          }}>
            {price}
          </Text>
          <Text style={{
            color: "rgba(255,255,255,0.4)", fontSize: 13, marginLeft: 4,
          }}>
            {period}
          </Text>
        </View>
        ...
        <View style={{ width: "100%", gap: 12, marginBottom: 20 }}>
          {features.map((feat, i) => (
            <View key={i} style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <Text style={{
                color: "rgba(255,255,255,0.7)", fontSize: 13, marginLeft: 10,
                fontWeight: "500",
              }}>
                {feat}
              </Text>
